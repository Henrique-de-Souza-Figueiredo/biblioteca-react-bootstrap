import css from "./gridLivro.module.css"
import BookLivro from "../bookCartao/bookCartao"
import Botao from "../Botao/Botao.jsx";

export default function GridLivro() {
    const livros = [
        {
            ...
            <div className={"row"}>
                {livros.map((livro, index) => (
                    <div className='col-md-3 col-12' key={index}>
                        <BookLivro titulo={livro.titulo} autor={livro.autor} tipo={livro.tipo} imagem={livro.imagem} />
                    </div>
                ))}
            </div>
            <div className={"d-flex justify-content-center mt-4 mb-5"}>
                <Botao  conteudo={"Ver Catalogo Completo"}/>
            </div>
